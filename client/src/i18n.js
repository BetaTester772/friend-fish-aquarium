...
export const catalogs = {
  en: {
    ...
    'fishing.idleHint': 'Tap the rod to start',
    'fishing.castAria': 'Start fishing',
    'fishing.waiting': 'Waiting near {name}…',
    'fishing.wait': 'Wait…',
    'fishing.waitHint': 'Pull the rod when the bobber jumps',
    'fishing.waitAria': 'Waiting for a bite. Pulling now will scare the fish.',
    'fishing.bite': 'A bite!',
    'fishing.reel': 'Reel now!',
    'fishing.biteHint': 'Pull the rod now!',
    'fishing.reelAria': 'Pull the fishing rod now',
  ...
  ko: {
    ...
    'fishing.cast': '낚시 시작',
    'fishing.idleHint': '낚싯대를 눌러 시작하세요',
    'fishing.castAria': '낚시 시작하기',
    'fishing.waiting': '{name} 물고기가 미끼를 물 때까지 기다리는 중…',
    'fishing.wait': '입질을 기다리세요…',
    'fishing.waitHint': '찌가 움직이면 낚싯대를 당기세요',
    'fishing.waitAria': '입질을 기다리는 중이에요. 지금 당기면 물고기가 도망가요.',
    'fishing.bite': '지금이에요!',
    'fishing.reel': '낚아 올리기!',
    'fishing.biteHint': '지금 낚싯대를 당기세요!',
    'fishing.reelAria': '지금 낚싯대 당기기',
