...
export const catalogs = {
  ...
  ko: {
    ...
    'fish.reactAria': '{name}님에게 {emoji} 반응 보내기',
    'fish.reactionError': '이모티콘 반응을 보낼 수 없어요',
    'fish.nudge': '💥 이 물고기 툭 치기',
    'fish.nudging': '툭 치는 중…',
    'fish.nudged': '{name}님을 툭 쳤어요',
    'fish.nudgeError': '지금은 물고기를 툭 칠 수 없어요',
    'fish.aria': '{name}{mine} — {status}, 포만도 {max} 중 {fullness}. 동작 열기.',
    'fish.mineSuffix': ' (나)',
    'fishing.idle': '운을 시험해 보세요',
    'fishing.cast': '🎣 낚싯줄 던지기',
    'fishing.waiting': '{name}님 근처에서 기다리는 중…',
    'fishing.wait': '기다리기…',
    'fishing.bite': '입질이 왔어요!',
    'fishing.reel': '지금 당기기!',
    'fishing.missed': '놓쳤어요',
    'fishing.tooEarly': '너무 빨라서 물고기가 놀랐어요',
    'fishing.tooLate': '너무 늦어서 물고기가 도망갔어요',
    'fishing.targetGone': '입질 전에 물고기가 떠났어요',
    'fishing.caught': '{name}님을 낚았어요! 안전하게 놓아줬어요.',
    'fishing.error': '지금은 물고기를 낚을 수 없어요',
    'effect.reactionAria': '{actor}님이 {emoji} 반응을 보냈어요',
    'effect.hitAria': '{actor}님이 물고기를 툭 쳤어요',
    'effect.catchAria': '{actor}님이 물고기를 낚았다 놓아줬어요',
    'activity.label': '활동',
    ...
    'api.invalid_reaction': '사용할 수 없는 반응이에요.',
    'api.cannot_hit_self': '내 물고기는 툭 칠 수 없어요.',
    'api.interaction_cooldown': '잠시 뒤에 다시 시도해 주세요.',
